...
export default function BlogPost() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-[#ccccdd]">
      <header className="border-b border-gray-200 px-6 py-4 flex items-center justify-between max-w-4xl mx-auto">
        <Link to="/blog" className="text-sm font-mono text-[#7c6aff] hover:underline">← Blog</Link>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <article className="prose prose-invert max-w-none prose-code:text-[#ff6a9b] prose-code:bg-[#1a1a24]">
        ...
        <div className="border-t border-gray-200 mt-16 pt-8">
          <Link to="/blog" className="text-sm font-mono text-gray-400 hover:text-[#7c6aff]">← Volver al blog</Link>
        </div>

        <RelatedPosts postId={post.id} theme="dark" />
      </main>
    </div>
  )
}
