  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-[#111111]">
      <header className="border-b border-gray-200 px-6 py-4 max-w-4xl mx-auto flex items-center justify-between">
        <Link to="/blog" className="text-sm font-mono hover:underline" style={{color: '#f59e0b'}}>← Blog</Link>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <article className="prose  max-w-none prose-headings:uppercase mb-16">
